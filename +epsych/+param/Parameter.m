classdef Parameter < handle & matlab.mixin.Copyable & matlab.mixin.SetGet
    % P = epsych.param.Parameter('Property','Value',...)
    ...
    methods
        function obj = Parameter(Name,Expression,varargin)
            ...
            for i = 1:2:length(varargin)
                ...
                assert(any(ind),'epsych.param.Parameter:Parameter:InvalidParameter', ...
        ...
        function set.ValueBounds(obj,vb)
            assert(numel(vb)==2 & isnumeric(vb),'epsych.param.Parameter:set.ValueBounds:InvalidEntry', ...
        ...
        function set.Select(obj,s)
            ...
            switch s
                case 'randRange'
                    assert(obj.N == 2,'epsych.param.Parameter:set.Select:InvalidNumVals', ...

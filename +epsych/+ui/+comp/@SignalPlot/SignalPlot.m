classdef SignalPlot < epsych.ui.comp.PlotHelper
% obj = SignalPlot(watchedParams,[ax],[BoxID])
    ...
    methods
        function obj = SignalPlot(watchedParams,varargin)
            ...
            obj = obj@epsych.ui.comp.PlotHelper(sprintf('SignalPlot_%s',watchedParams{1}),varargin{:});
            
            obj.watchedParams = watchedParams;
            
            obj.add_context_menu; % function inherited from epsych.ui.comp.PlotHelper
            
            obj.more_context_menus;
            
            % assign local functions to timer inherited from epsych.ui.comp.PlotHelper

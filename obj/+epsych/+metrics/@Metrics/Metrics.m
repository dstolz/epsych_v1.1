classdef Metrics < handle & matlab.mixin.Copyable
    ...
    properties (SetAccess = protected) % Abstract
        ...
        TrialTypes = [epsych.Bits.TrialType_0, ...
                      epsych.Bits.TrialType_1, ...
                      epsych.Bits.TrialType_2, ...
                      epsych.Bits.TrialType_3];
                    
        BitsInUse  = [epsych.Bits.Hit, ...
                      epsych.Bits.Miss, ...
                      epsych.Bits.Response_A, ...
                      epsych.Bits.Response_B, ...
                      epsych.Bits.NoResponse, ...
                      epsych.Bits.Abort];
    ...
    properties (Dependent)
        ...
        ResponsesBitmask    (1,:) epsych.Bits

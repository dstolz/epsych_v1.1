classdef (ConstructOnLoad) enBitmask < dynamicprops & matlab.mixin.Copyable
    % [lsb msb]
    ...
    methods
        ...
        function add_user_bit(obj,bit,label)
            ...
            assert(bit > 16 & bit <= 32,'epsych.enBitmask:add_user_bit:InvalidBit', ...
    ...
    methods (Static)
        ...
        function b = bitmask2bits(bm)
            b = find(epsych.enBitmask.bitmask2bool(bm));
        end

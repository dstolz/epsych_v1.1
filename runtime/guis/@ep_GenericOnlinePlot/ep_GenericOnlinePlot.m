classdef ep_GenericOnlinePlot < ep_GenericGUIHelper & handle
    ...
    methods
        ...
        function set.yPositions(obj,y)
            assert(length(y) == obj.N,'epsych:ep_GenericOnlinePlot:set.yPositions', ...
        ...
        function error(obj,varargin)
            vprintf(-1,'ep_GenericOnlinePlot closed with error')
